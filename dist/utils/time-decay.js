 ...
 */
export function getAgeInMonths(commitDate, referenceDate) {
    ...
    const dayFraction = (referenceDate.getDate() - commitDate.getDate()) /
 ...
 */
export function timeDecayWeight(commitDate, referenceDate) {
