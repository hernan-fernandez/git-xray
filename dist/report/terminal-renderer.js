 ...
 */
function horizontalRule(left, mid, right, widths) {
 ...
 */
function sectionHeader(chalk, title) {
    return '\n' + chalk.bold.cyan(`═══ ${title} ═══`) + '\n';
}
/**
 * Render the Contributors section.
 */
function renderContributors(chalk, data) {
    const lines = [];
 ...
 */
function renderHotspots(chalk, data) {
    const lines = [];
 ...
 */
function renderComplexityTrend(chalk, data) {
    const lines = [];
 ...
 */
function renderBusFactor(chalk, data) {
    const lines = [];
 ...
 */
function renderPRVelocity(chalk, data) {
    const lines = [];
 ...
 */
export function renderTerminalReport(reportData, noColor) {
